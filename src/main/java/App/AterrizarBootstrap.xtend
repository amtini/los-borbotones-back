...
class AterrizarBootstrap {
	def static void main(String[] args) {
		...
		repoVuelo.createIfNotExists(vueloBSaRio)
		repoVuelo.createIfNotExists(vueloBSaJamaica)
		repoVuelo.createIfNotExists(vueloAFrancia)
		repoVuelo.createIfNotExists(vueloBSaChile)
		repoVuelo.createIfNotExists(vueloBSaMiami)
		repoVuelo.createIfNotExists(vueloBSaItalia)
		repoVuelo.createIfNotExists(vueloBSaAustralia)
		repoVuelo.createIfNotExists(vueloBSaInglaterra)
		repoVuelo.createIfNotExists(vueloARGaCHILEaCUBA)
